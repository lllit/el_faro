...
<div class="column is-3">
  ...
  <ul>
    ...
    <li><a href="../paginas/contacto.php" class="has-text-light">Contacto</a></li>
    <li><a href="../paginas/avisos.php" class="has-text-light">Avisos</a></li>
    <li><a href="../paginas/registro.php" class="has-text-light">Registro</a></li>
  </ul>
</div>
